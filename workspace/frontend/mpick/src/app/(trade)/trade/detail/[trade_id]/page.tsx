  ...
  return (
    <div>
      <Card className="py-4 flex mt-2">
        ...
        <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
          ...
          <p className="mt-4 ml-2">
            {detail.mainCategory} | {detail.subCategory ? detail.subCategory : "없음"} |{" "}
            {detail.tradeBabyMonth} |
          ...
          <p className="mt-4 ml-2 mr-2">{detail.tradeExplain}</p>
        ...
        {userNickName === detail.nickname ? (
          ...
          <Button
            className="bg-[#5E9FF2] text-white text-md flex items-center mt-4"
            size="lg"
            fullWidth={true}
            onClick={() => {
              router.push(`/chat/start/${tradeId}`);
            }}
          >
      ...
      <Button
        ...
        style={{ position: "absolute", top: "50px", right: "30px", zIndex: "10" }}
        isIconOnly
        onClick={() => {
          toggleLike();
          addWish();
