  ...
  return (
    ...
    <GoBack />
      ...
      <CardHeader className="pb-0 pt-2 px-4 flex-col items-start">
        <Avatar isBordered color="default" src={detail.tradeImages[0]} />
        <h4 className="font-bold text-large">{detail.nickname}</h4>
        <span>
        <svg
        ...
        <p className="text-tiny uppercase font-bold">{detail.title}</p>
        <small className="text-default-500">₩ {detail.price}</small>
        <p>{detail.mainCategory} | { detail.subCategory ? detail.subCategory : "없음" } | {detail.tradeBabyMonth} | {detail.tradeStatus}</p>
        <p>{detail.tradeExplain} Lorem ipsum dolor, sit amet consectetur adipisicing elit. Exercitationem sed maxime officiis soluta expedita cum. Dicta eos, modi distinctio velit explicabo cum sapiente vero earum hic dolore harum eveniet. Tempore.</p>
